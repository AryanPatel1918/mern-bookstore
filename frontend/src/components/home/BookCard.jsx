...
export default function BookCard({ book }) {
  ...
  return (
    <>
      <div className='border border-b-4 border-blue-400 rounded-lg px-4 py-2 relative hover:shadow-xl hover:shadow-blue-400/40 hover:-translate-y-1 md:hover:-translate-y-2 transition duration-300 ease-in-out'>
